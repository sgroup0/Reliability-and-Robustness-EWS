...
plot(mu_list(selection_H_not_1), 0 * p_list_var_maxima(selection_H_not_1), 'LineStyle', 'none', 'LineWidth', line_width, 'Marker', 'x', 'MarkerSize', marker_size, 'MarkerFaceColor', PS.Red2, 'MarkerEdgeColor', PS.Red4);
...
plot(mu_list(selection_H_not_1), 0 * p_list_sk_maxima(selection_H_not_1), 'LineStyle', 'none', 'LineWidth', line_width, 'Marker', 'x', 'MarkerSize', marker_size, 'MarkerFaceColor', PS.Red2, 'MarkerEdgeColor', PS.Red4);
...
plot(mu_list(selection_H_not_1), 0 * p_list_kr_maxima(selection_H_not_1), 'LineStyle', 'none', 'LineWidth', line_width, 'Marker', 'x', 'MarkerSize', marker_size, 'MarkerFaceColor', PS.Red2, 'MarkerEdgeColor', PS.Red4);
...
plot(mu_list(selection_H_not_1), 0 * p_list_AC_maxima(selection_H_not_1), 'LineStyle', 'none', 'LineWidth', line_width, 'Marker', 'x', 'MarkerSize', marker_size, 'MarkerFaceColor', PS.Red2, 'MarkerEdgeColor', PS.Red4);
...
plot(mu_list(selection_H_not_1), 0 * p_list_H_maxima(selection_H_not_1), 'LineStyle', 'none', 'LineWidth', line_width, 'Marker', 'x', 'MarkerSize', marker_size, 'MarkerFaceColor', PS.Red2, 'MarkerEdgeColor', PS.Red4);
