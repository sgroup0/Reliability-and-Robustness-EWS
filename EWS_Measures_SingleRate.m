...
window_size_list = [289, 192.67, 144.5, 115.6, 96.33, 82.57, 72.25, 64.22, 57.8, 52.54, 48.167, 44.46,41.29, 38.53, 36.13, 34, 32.11, 30.42, 28.9, 27.52, ...
26.27, 25.13, 24.08, 23.12, 22.23, 21.41, 20.64, 19.93, 19.267, 18.65, 18.06, 17.51, 17, 16.51, 16.05, 15.62, 15.21, 14.82, 14.45, 14.09, 13.76, 13.44, ...
13.13, 12.84, 12.56, 12.29, 12.04, 11.79, 11.56];
...
window_size_in_seconds = window_size_list(n);
...
% Calculate Kendall-tau and determine whether to reject or retain null hypothesis till bifurcation point
...
fprintf('Var: tau = %.6f, z = %.3f, p = %.8f, H = %d\n', tau_maxima.var, z_maxima.var, p_maxima.var, H_maxima.var);
fprintf('Sk : tau = %.6f, z = %.3f, p = %.8f, H = %d\n', tau_maxima.sk, z_maxima.sk, p_maxima.sk, H_maxima.sk);
fprintf('Kr : tau = %.6f, z = %.3f, p = %.8f, H = %d\n', tau_maxima.kr, z_maxima.kr, p_maxima.kr, H_maxima.kr);
fprintf('AC : tau = %.6f, z = %.3f, p = %.8f, H = %d\n', tau_maxima.AC, z_maxima.AC, p_maxima.AC, H_maxima.AC);
fprintf('H  : tau = %.6f, z = %.3f, p = %.8f, H = %d\n', tau_maxima.H, z_maxima.H, p_maxima.H, H_maxima.H);
